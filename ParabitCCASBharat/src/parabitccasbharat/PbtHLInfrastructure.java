...
public class PbtHLInfrastructure extends javax.swing.JDialog {
     ...
     */
    public PbtHLInfrastructure(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PbtHLInfrastructure dialog = new PbtHLInfrastructure(new javax.swing.JFrame(), true);

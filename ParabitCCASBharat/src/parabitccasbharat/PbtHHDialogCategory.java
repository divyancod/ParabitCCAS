 ...
 * @author Asus
 */
public class PbtHHDialogCategory extends javax.swing.JDialog implements ActionListener {

    /**
     * Creates new form PbtHHDialogCategory
     */
    PbtSingleMemberDashBoard dashBoard;
    PbtHHModel hhmodel;
    public PbtHHDialogCategory(PbtSingleMemberDashBoard parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dashBoard=parent;
    ...
    private void initComponents() {
        ...
        b4.setText("Physically Handicapped");

        b5.setText("SC");

        b6.setText("Economic Weaker Section");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PbtHHDialogCategory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==b1)
            hhmodel.setCategory("1");
        else if(e.getSource()==b2)
            hhmodel.setCategory("2");
        else if(e.getSource()==b3)
            hhmodel.setCategory("3");
        else if(e.getSource()==b4)
            hhmodel.setCategory("4");
        else if(e.getSource()==b5)
            hhmodel.setCategory("5");
        else if(e.getSource()==b6)
            hhmodel.setCategory("6");
        else if(e.getSource()==b7)
            hhmodel.setCategory("7");

 ...
 * @author Asus
 */
public class PbtHLDialogFloor extends javax.swing.JDialog implements ActionListener {

    /**
     * Creates new form PbtHLFloor
     */
    PbtHLModel hlmodel;
    long tfloor;
    PbtHLDashBoard dashBoard;
    public PbtHLDialogFloor(PbtHLDashBoard parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dashBoard=parent;
    ...
    public String getFloor(long floor)
    {
        dispose();
        String s="";
        switch ((int)floor) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PbtHLDialogFloor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

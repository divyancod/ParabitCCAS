 ...
 * @author Asus
 */
public class PbtHLDialogAccessToilet extends javax.swing.JDialog implements ActionListener{

    /**
     * Creates new form PbtHHDialogAccessToilet
     */
    PbtHLDashBoard dashBoard;
    PbtHLModel hlmodel; 
    long access;
    public PbtHLDialogAccessToilet(PbtHLDashBoard parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dashBoard=parent;
...
public String getAccess(long floor)
    {
        dispose();
        String s="";
        switch ((int)floor) {
    ...
    private void initComponents() {
        ...
        b1.setText("Exclusively for Household only");

        b2.setText("Share with other Household");

        b3.setText("Public Latrine");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PbtHLDialogAccessToilet.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

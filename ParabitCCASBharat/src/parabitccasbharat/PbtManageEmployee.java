 ...
 * @author Asus
 */
public class PbtManageEmployee extends javax.swing.JDialog {

    /**
     * Creates new form PbtManageEmployee
     */
    PbtEmpDashBoard pbtempdashboard;
    public PbtManageEmployee(PbtEmpDashBoard parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         PbtNewAppoint ob=new PbtNewAppoint(pbtempdashboard);
         setVisible(false);
         ob.setVisible(true);
         setVisible(true);

 ...
 * @author Asus
 */
public class PbtUseOfHouse extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jButton2.setText("Residence cum other use");

        jButton3.setText("Hostel/Lodge/Guest House");
        ...
        jButton6.setText("Hospital/Dispensary");

        jButton7.setText("Factory/WorkShop/Workshed");

        jButton8.setText("Place of Workship");

        jButton9.setText("Other Non Residential Use");

        jButton10.setText("Vacant");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PbtUseOfHouse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

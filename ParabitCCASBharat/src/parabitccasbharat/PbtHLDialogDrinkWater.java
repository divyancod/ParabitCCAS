 ...
 * @author Asus
 */
public class PbtHLDialogDrinkWater extends javax.swing.JDialog implements ActionListener{

    /**
     * Creates new form PbtHLDialogDrinkWater
     */
    PbtHLModel hlmodel;
    long water;
    PbtHLDashBoard dashBoard;
    public PbtHLDialogDrinkWater(PbtHLDashBoard parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dashBoard=parent;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PbtHLDialogDrinkWater.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        hlmodel.setMainSrcDrWater(water);

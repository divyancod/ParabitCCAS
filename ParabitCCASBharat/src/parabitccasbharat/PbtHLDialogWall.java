 ...
 * @author Asus
 */
public class PbtHLDialogWall extends javax.swing.JDialog implements ActionListener {

    /**
     * Creates new form PbtHLDialogWall
     */
    PbtHLModel hlmodel;
    long twall;
    PbtHLDashBoard dashBoard;
    public PbtHLDialogWall(PbtHLDashBoard parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dashBoard=parent;
    ...
    public String getWall(long floor)
    {
        dispose();
        String s="";
        switch ((int)floor) {
    ...
    private void initComponents() {
        ...
        b1.setText("Grass/Tatch/Bamboo");

        b2.setText("Plastic/Polythene");

        b3.setText("Mud/Unbrunt Bricks");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PbtHLDialogWall.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

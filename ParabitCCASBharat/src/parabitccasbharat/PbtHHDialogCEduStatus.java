 ...
 * @author Asus
 */
public class PbtHHDialogCEduStatus extends javax.swing.JDialog implements ActionListener{

    /**
     * Creates new form PbtHHDialogCEduStatus
     */
    PbtSingleMemberDashBoard dashBoard;
    PbtHHModel hhmodel;
    public PbtHHDialogCEduStatus(PbtSingleMemberDashBoard parent, boolean modal) {
        super(parent, modal);
        initComponents();
        dashBoard=parent;
    ...
    private void initComponents() {
        ...
        b3.setText("Vocational");

        b4.setText("Special Institute of Disabled");

        b5.setText("Literacy Centre");

        b6.setText("Other Institution");

        b8.setText("Never Attended");

        b7.setText("Attended Before");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PbtHHDialogCEduStatus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==b1)
            hhmodel.setCEduStatus("1");
        else if(e.getSource()==b2)
            hhmodel.setCEduStatus("2");
        else if(e.getSource()==b3)
            hhmodel.setCEduStatus("3");
        else if(e.getSource()==b4)
            hhmodel.setCEduStatus("4");
        else if(e.getSource()==b5)
            hhmodel.setCEduStatus("5");
        else if(e.getSource()==b6)
            hhmodel.setCEduStatus("6");
        else if(e.getSource()==b7)
            hhmodel.setCEduStatus("7");
        else if(e.getSource()==b8)
            hhmodel.setCEduStatus("8");
